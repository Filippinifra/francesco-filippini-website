  ...
  en: [
    {
      ...
      textList: [
        ...
        {
          text: 'I significantly contributed building part of the website frontend.',
        },
        {
    ...
    },
    {
      ...
      textList: [
        {
          text: "My team builds SaaS software for 'Cessione del quinto', an Italian Administration process to obtain a loan.",
        },
  ...
  it: [
    {
      ...
      textList: [
        ...
        {
          text: 'Ho contribuito sviluppando parte del frontend della piattaforma.',
        },
        {
    ...
    },
    {
      ...
      title: 'Finleap',
      position: 'Junior Frontend Developer',
      period: 'Ottobre 2019 - Aprile 2020',
      location: 'Milano',
      textList: [
        {
          text:
    ...
    },
    {
      logoImg: smbLogo,
      title: 'Saint Mary Boulevard',
      position: 'Manager e Founder',
      period: 'Marzo 2016 - Oggi',
      location: 'Verona',
      textList: [
        {
          text: "Ho incominciato questo progetto all'età di 20 anni con mio fratello.",
        },
        {
          text:
